<div class="comments index">
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($comment['Publication']['title'], array('controller' => 'publications', 'action' => 'view', $comment['Publication']['id'])); ?>
		</td>
		<td><?php echo h($comment['Comment']['schedule']); ?>&nbsp;</td>

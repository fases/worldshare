<div class="users index">
	...
	<tr>
		<td><?php echo $teacher['User']['id']; ?>&nbsp;</td>
		<td><?php echo $teacher['User']['name']; ?>&nbsp;</td>
		<td><?php echo $teacher['User']['password']; ?>&nbsp;</td>
		<td><?php echo $teacher['User']['email']; ?>&nbsp;</td>
		<td><?php echo $teacher['User']['phone']; ?>&nbsp;</td>
		<td><?php echo $teacher['User']['address']; ?>&nbsp;</td>
		<td><?php echo $teacher['User']['registration']; ?>&nbsp;</td>
		<td><?php echo ($teacher['User']['role'] == 0?'teacher':'Professor'); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $teacher['User']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $teacher['User']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $teacher['User']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $teacher['User']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>

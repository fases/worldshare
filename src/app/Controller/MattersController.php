	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->Matter->save($this->request->data)) {
				$this->Session->setFlash(__('The matter has been saved.'));
				return $this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('The matter could not be saved. Please, try again.'));
			}
		}
	}
 ...
 */
	public function delete($id = null) {
		...
		if ($this->Matter->delete()) {
			$this->Session->setFlash(__('The matter has been deleted.'));
		} else {
			$this->Session->setFlash(__('The matter could not be deleted. Please, try again.'));
		}
		return $this->redirect(array('action' => 'index'));
	}
}
